...
class CancelResponseParserTest extends TestCase
{
    ...
    {
        $content = \file_get_contents(__DIR__ . '/../../../stub/nestpay/response/cancel_successful.xml');
        ...
        $this->assertEquals('PB6356', $cancelResponse->getAuthCode());
        $this->assertEquals('15335I94G07024820', $cancelResponse->getTransactionId());
    }

    public function test_parse_with_failed_message()
    {
        $content = \file_get_contents(__DIR__ . '/../../../stub/nestpay/response/cancel_failed.xml');
        /** @var ResponseInterface $responseMock */
        $responseMock = $this->getResponseMock($content);
