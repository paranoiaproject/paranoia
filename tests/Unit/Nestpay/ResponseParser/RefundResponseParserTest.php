...
class RefundResponseParserTest extends TestCase
{
    ...
    {
        $content = \file_get_contents(__DIR__ . '/../../../stub/nestpay/response/refund_successful.xml');
        ...
        $this->assertEquals('PB6356', $refundResponse->getAuthCode());
        $this->assertEquals('15335I94G07024820', $refundResponse->getTransactionId());
    }

    public function test_parse_with_failed_message()
    {
        $content = \file_get_contents(__DIR__ . '/../../../stub/nestpay/response/refund_failed.xml');
        /** @var ResponseInterface $responseMock */
        $responseMock = $this->getResponseMock($content);
