...
class ChargeRequestBuilderTest extends TestCase
{
    ...
    {
        return [
            [null, __DIR__ . '/../../../stub/posnet/request/charge_without_installment.xml'],
            [1, __DIR__ . '/../../../stub/posnet/request/charge_without_installment.xml'],
            [8, __DIR__ . '/../../../stub/posnet/request/charge_with_installment.xml'],
        ];
    }
     ...
     */
    public function getRequestBuilder(PosnetConfiguration $configuration): ChargeRequestBuilder
    {
