...
class GvpTest extends PHPUnit_Framework_TestCase
{
    ...
    */
    private function _createNewOrder($orderId = null, $amount = 100)
    {
        ...
        $request->setCardNumber('5407099016729014');
        $request->setSecurityCode(395);
        $request->setExpireMonth(3);
        $request->setExpireYear(2014);
        return $request;
    }
    ...
    */
    public function testCase3()
    {
        ...
        $this->_makeRefund($request);
        $request->setAmount(5);
        $result = $this->_makeRefund($request, false);
